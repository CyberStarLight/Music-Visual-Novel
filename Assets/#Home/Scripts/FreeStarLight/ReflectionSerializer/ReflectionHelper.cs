...
static class ReflectionHelper
{
    ...
    public static readonly BindingFlags AllFieldsAndProperties = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.FlattenHierarchy;
